<div class="{{ $class ?? '' }}  c-rating">
	<div class="c-rating__container container">
        ...
        <div class="c-rating__inner">
            ...
            <div class="c-rating__arrow ui-slider-arrow ui-slider-arrow--next js--rating-next">
                <span class="ui-slider-arrow__line"></span>
            </div>
            <div class="c-rating__arrow ui-slider-arrow ui-slider-arrow--prev js--rating-prev">
                <span class="ui-slider-arrow__line"></span>
            </div>
        </div>
	</div>
