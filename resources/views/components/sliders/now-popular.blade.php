<div class="{{ $class ?? '' }}  c-now-popular">
	<div class="c-now-popular__container container">
		...
		<div class="c-now-popular__inner">
			...
			<div class="c-now-popular__arrow ui-slider-arrow ui-slider-arrow--next js--now-popular-next">
				<span class="ui-slider-arrow__line"></span>
			</div>
			<div class="c-now-popular__arrow ui-slider-arrow ui-slider-arrow--prev js--now-popular-prev">
				<span class="ui-slider-arrow__line"></span>
			</div>
		</div>
	</div>
